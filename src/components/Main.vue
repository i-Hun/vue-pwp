	...
	<header class="main-header hero is-medium">
		...
		<div class="section">
			<b-tabs expanded>
				...
				<b-tab-item label="📑 Research papers">
					<ul>
						<li v-for="publication in publications">
							{{publication.title}}
<!-- 							{{pubTitle(publication.file)}} <small>
								<a :href="'../assets/articles/' + publication.file">.pdf</a>
							</small> -->
						</li>
					</ul>
				</b-tab-item>

				<b-tab-item :visible="showBooks" label="🎓 Education">
					<ul>
				...
				<b-tab-item label="📚 Additiional education">
					<ul>
