const conferences = [
	...
	},
	{
		...
		speech: [
			{
				file: null,
				title: "Mining problematic media topics online: what reader comments can tell us about readers’ perception of news agendas",
				type: "Oral presentation"
			}
		]
	},
	{
		...
		speech: [
			{
				file: null,
				title: "Mining Media Topics Perceived as Social Problems by Online Audiences: Readers’ Perception of News Agendas",
				type: "Oral presentation"
			},
			{
				file: null,
	...
	{
		title: "VII Международная научно-практическая конференция памяти А.О. Крыштановского «Методы и процедуры социологических исследований»",
		shortTitle: "Конференция Крыштановского",
		place: {
			city: "Moscow",
			country: "Russia",
			iso: "ru"
		...
		speech: [
			{
				file: null,
				title: "Возможности и ограничения метода тематического моделирования в социологических исследованиях",
				type: "Oral presentation"
			}
		]
	},
	{
		title: "IV Международная научная конференция \"Математическое и компьютерное моделирование\"",
		shortTitle: null,
		place: {
			city: "Omsk",
			country: "Russia",
